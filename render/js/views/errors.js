...
const ERROR_FIELDS = {
    ...
    // Тип объекта, тип сделки и этажность пока объединяются движком
    // сравнения в «Другие несоответствия». Всё равно показываем их
    // значения по каждому источнику, чтобы ошибку можно было исправить.
